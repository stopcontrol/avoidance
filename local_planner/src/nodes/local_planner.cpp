...
void LocalPlanner::dynamicReconfigureSetParams(
  ...
  min_cloud_size_ = static_cast<float>(config.min_cloud_size_);
  n_points_occupied_ = static_cast<float>(config.n_points_occupied_);
  ...
  pointcloud_timeout_hover_ = static_cast<float>(config.pointcloud_timeout_hover_);
  pointcloud_timeout_land_ = static_cast<float>(config.pointcloud_timeout_land_);
